university=# create database school;
CREATE DATABASE
university=# \c school 
...
CREATE TABLE
school=# CREATE TABLE student_course(
...
CREATE TABLE
school=# INSERT INTO student (student_id, name, lastname, phone, age)
VALUES 
...
INSERT 0 30
school=# INSERT INTO course (course_id, course_name)
VALUES 
...
INSERT 0 5
school=# INSERT INTO student_course (student_course_id, student_id, course_id) 
VALUES 
...
INSERT 0 40
school=# INSERT INTO grade (student_course_id, grade) VALUES
...
INSERT 0 40
--2-task--
SELECT sc.course_id, s.name, s.lastname, g.grade
...
WHERE g.grade = (
    ...
    JOIN grade g2 ON sc2.student_course_id = g2.student_course_id
    WHERE sc2.course_id = sc.course_id
);

--3-task--

SELECT sc.course_id, c.course_name, AVG(g.grade) as average_grade
FROM student_course sc
...
JOIN 
    student s ON sc.student_id = s.student_id
JOIN 
    youngest_in_groups yig ON sc.course_id = yig.course_id AND s.age = yig.youngest_age
ORDER BY 
    sc.course_id, s.age;
...
SELECT ag.course_id, ag.course_name, ag.average_grade
FROM average_grades ag
WHERE ag.average_grade = (
